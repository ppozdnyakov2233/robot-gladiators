...
var shop = function() {
  ...
  var shopOptionPrompt = window.prompt(
    "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one 1 for REFIL , 2 for UPGRADE, or 3 for LEAVE."
  );

  // convert answer from attempt to an actual number
